 ...
 * Code
 ******************************************************************************/
void SRTM_SaiEdmaAdapter_GetAudioServiceState(srtm_sai_adapter_t adapter, srtm_audio_state_t *pTxState,
...
static srtm_status_t SRTM_SaiEdmaAdapter_SetParam(srtm_sai_adapter_t adapter, srtm_audio_dir_t dir, uint8_t index,
                                                  uint8_t format, uint8_t channels, uint32_t srate)
{
    srtm_sai_edma_adapter_t handle = (srtm_sai_edma_adapter_t)(void *)adapter;
#if SRTM_SAI_EDMA_CONFIG_RX_ENABLE
    srtm_sai_edma_runtime_t rtm = dir == SRTM_AudioDirTx ? &handle->txRtm : &handle->rxRtm;
...
static srtm_status_t SRTM_SaiEdmaAdapter_SetBuf(srtm_sai_adapter_t adapter, srtm_audio_dir_t dir, uint8_t index,
                                                uint8_t *bufAddr, uint32_t bufSize, uint32_t periodSize,
                                                uint32_t periodIdx)
{
    srtm_sai_edma_adapter_t handle = (srtm_sai_edma_adapter_t)(void *)adapter;
#if SRTM_SAI_EDMA_CONFIG_RX_ENABLE
...
static srtm_status_t SRTM_SaiEdmaAdapter_GetBufOffset(srtm_sai_adapter_t adapter, srtm_audio_dir_t dir, uint8_t index,
                                                      uint32_t *pOffset)
{
    srtm_sai_edma_adapter_t handle = (srtm_sai_edma_adapter_t)(void *)adapter;
#if SRTM_SAI_EDMA_CONFIG_RX_ENABLE
...
static srtm_status_t SRTM_SaiEdmaAdapter_PeriodReady(srtm_sai_adapter_t adapter, srtm_audio_dir_t dir, uint8_t index,
                                                     uint32_t periodIdx)
{
    srtm_status_t status           = SRTM_Status_Success;
    srtm_sai_edma_adapter_t handle = (srtm_sai_edma_adapter_t)(void *)adapter;
...
srtm_sai_adapter_t SRTM_SaiEdmaAdapter_Create(I2S_Type *sai, void *dma, srtm_sai_edma_config_t *txConfig,
                                              srtm_sai_edma_config_t *rxConfig)
{
...
#if SRTM_SAI_EDMA_LOCAL_BUF_ENABLE
static inline void SRTM_SaiEdmaAdapter_SetLocalBuf(srtm_sai_adapter_t adapter, srtm_sai_edma_local_buf_t *localBuf,
...
#if SRTM_SAI_EDMA_CONFIG_RX_ENABLE
void SRTM_SaiEdmaAdapter_SetDataHandlerOnHostSuspend(srtm_sai_adapter_t adapter, srtm_sai_edma_data_callback_t cb,
                                                     void *param)
{
    srtm_sai_edma_adapter_t handle = (srtm_sai_edma_adapter_t)(void *)adapter;
