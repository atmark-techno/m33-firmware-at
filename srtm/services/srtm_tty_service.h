...
typedef int (*srtm_tty_service_set_termios_t)(uint8_t port_idx, struct ktermios *termios);
...
typedef int (*srtm_tty_service_control_t)(uint8_t port_idx, uint32_t mask_n_flag);
